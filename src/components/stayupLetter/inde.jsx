  ...
  return (
    <div className=" mt-[40px] h[400px]">
      <div className="wrapper p-[40px] bg-gradient-to-br  dark:from-[#040b0b] dark:to-[#162729] from-[#F6FEFF] to-[#75cfdc] text-[#000] dark:text-[#FF7714]">
        <div className="des">
          <h4 className="text-center text:10px md:text-[20px] font-[100]">STAY UP-TO-DAY</h4>
          <h2 className="Title text-center text-[30px] md:text-[40px] font-[600] my-[20px]">Get Our Product Delivered To You</h2>
