...
import CVEXAMPLE from "../../images/CVEXAMPLE.svg";
    ...
    <BannerStyle>
      <div className="banner flex justify-between">
        ...
        >
          ...
          <motion.h2 className="dark:text-[#ffff]" variants={textVariants}     whileHover="hover">
        ...
        <motion.div
          variants={CvVariants}
          className="mr-[200px] mt-[50px] "
          initial="initial"
          animate="animate"
          whileHover="hover"
        >
          <Image preview={false} src={CVEXAMPLE} />
        </motion.div>
      </div>
    </BannerStyle>
  );
