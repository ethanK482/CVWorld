          ...
          {activeTab === 1 && (
            <motion.div>
              ...
              >
                {isShowFront ? (
                  <img
                  className="w-[18rem] h-[20rem] md:w-[28rem] md:h-[28.25rem]"
                    src={image3}
                  />
                ) : (
                  <img
          ...
          {activeTab === 2 && (
            <motion.div>
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="relative z-10 xl:right-[100px] sm:left-[50px] md:right-[-55px] right-[0px] "
              >
                <img width className="xl:w-[15.6rem] w-[300px]" src={image5} /> 

                <DownloadOutlined
                  className="xl:bottom-[17rem] xl:right-[-7rem] md:bottom-[13rem] md:right-[13rem] bottom-[16rem] left-[6rem]"
                  style={{
                    fontSize: "100px",
                    color: "#FF7714",
                    position: "relative",
